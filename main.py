...
# no modificar def retrieve_phone_code(driver) -> str#
...
class UrbanRoutesPage:
    # Localizadores de los elementos de la página web
    ...
    travel_details = (By.CLASS_NAME,"order-body")
    ...
    def request_blanket_and_tissues(self):
        self.driver.implicitly_wait(20)
        #self.driver.execute_script("arguments[0].scrollIntoView();", *self.blanket_and_scarves)
    ...
    # hacer clink en detalle del viaje
    def details_travel_click(self):
        self.driver.implicitly_wait(20)
        self.driver.find_element(*self.travel_details).click()

class TestUrbanRoutes:
    driver = None

    # Preparar clase de prueba
    @classmethod
    def setup_class(cls):
    ...
    # Prueba de establecimiento de ruta(Accede a la ruta y la abre en selenium)
    ...
    # Prueba del flujo completo de solicitud de taxi
    def test_full_taxi_request_process(self):
        ...
        #Selecciona la casilla de direcciones y las llena
        routes_page.set_route(address_from, address_to)
        assert routes_page.get_from() == address_from
        assert routes_page.get_to() == address_to
        routes_page.select_taxi_button()
        sleep(2)
        # Selecciona la el botón taxi y la opción Comfort.
        routes_page.select_comfort_rate()
        sleep(2)
        #3. Rellenar el número de teléfono.
        # Selecciona la casilla de datos de número telefónico
        ...
        #hacer click en método de pago y añadir método y cerrar ventana
        ...
        #Se ingresa el mensaje solicitado en la casilla de mensaje
